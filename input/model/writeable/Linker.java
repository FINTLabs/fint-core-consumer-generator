...
public class MODELLinker extends FintLinker<MODEL_RESOURCE> {
    ...
    public void mapLinks(MODEL_REOSURCE resource) {
    ...
    @Override
    public String getSelfHref(MODEL_RESOURCE resource) {
        return getAllSelfHrefs(resource).findFirst().orElse(null);
    }

    @Override
    public Stream<String> getAllSelfHrefs(MODEL_RESOURCE resource) {
    ...
    int[] hashCodes(MODEL_RESOURCE resource) {
